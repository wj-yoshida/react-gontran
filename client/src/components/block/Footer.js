                ...
                <div className="footer__wrap">
                    <div className="footer__top">
                        <div className="footer__top__box">
                            ...
                            <Link href="/?mode=f3">運営会社</Link>
                            <Link href="https://gontrancherrier.shop-pro.jp/secure/?mode=inq&amp;shop_back_url=https%3A%2F%2Fgontrancherrier.jp%2F&amp;shop_id=PA01461818">お問い合わせ</Link>
                        </div>
                        <div className="footer__top__box">                        
                        </div>
                        <div className="footer__top__box">
                        ...
                        <div className="footer__top__box">
                            ...
                            <Link href="https://www.instagram.com/gontrancherrierjp/" target="_blank" className="font-minervamodern insta">Instagram</Link>
                        </div>
                    </div>
